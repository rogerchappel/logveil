...
Replace this section with the supported versions for `logveil`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `logveil` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in logveil.
